...
/// <summary>
/// Вешается на любой объект с MeshRenderer.
/// Включает/выключает контурный меш при наведении.
/// </summary>
...
public class OutlineEffect : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        // Создаём расширенный массив: оригинальные + outline материал последним
    ...
    // Сбросить при уничтожении или отключении
